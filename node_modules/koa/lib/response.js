...
// 这是es6的 赋值或者执行
  ...
  redirect(url, alt) {
    ...
    // status
    if (!statuses.redirect[this.status]) this.status = 302;// 哈哈  302 只要社会
  ...
  set lastModified(val) { // 最后修改的时间这个给力 设置相应头部
  ...
  set(field, val) {
    if (2 == arguments.length) {
      ...
      this.res.setHeader(field, val); //设置头部 和原生的一个性质和cookie的设置好像是一样的
    } else {
